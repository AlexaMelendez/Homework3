...
cig.data <- read_csv("C:\\Users\\melen\\OneDrive\\Documents\\Econ_470\\Homework3\\data\\input\\CDC_1970-2018.csv", col_names = TRUE)

cpi.data <- read_xlsx("C:\\Users\\melen\\OneDrive\\Documents\\Econ_470\\Homework3\\data\\input\\CPI_1913_2019.xlsx", skip = 11)
...
# Fix pivot_wider error by removing "measure" from id_cols
final.data <- pivot_wider(cig.data, 
                         id_cols = c("state", "Year"),  # <-- FIXED!
                         names_from = "measure",
                         values_from = "value") %>%
  arrange(state, Year)
